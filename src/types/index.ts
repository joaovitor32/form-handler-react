...
export type FormInterface = FormHTMLAttributes<HTMLFormElement>

export type EventInterface = React.FormEvent<HTMLInputElement>

export type ChildrenArray<T> =
...
export interface UseFieldsAndValidationsHookFunctions<T, U> {
  ...
  getInputByName: (
    name: string
  ) => ReactElement<T, string | JSXElementConstructor<any>> | undefined
}
